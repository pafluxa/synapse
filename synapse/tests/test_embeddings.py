...
def test_zwei_with_numerical_embedding():
    ...
    numerical_emb = NumericalEmbedding(max_depths=[2]*sum(zwei_max_depths))  # 2 possible values per binary token
